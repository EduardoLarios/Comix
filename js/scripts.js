...
var app = new Vue({
    el: "#app",
    data: {
        comics: ["1.png", "2.png", "3.png", "4.png", "5.jpg", "6.jpeg"],
        selected: 5
    },
    computed: {
        current() { return `images/comics/${this.comics[this.selected]}` }
    },
    methods: {
        previous() {
            if (this.selected > 0) {
        ...
        random() {
            ...
            do {
                random = Math.floor(Math.random() * 10) % 6;
            } while (random == this.selected);
